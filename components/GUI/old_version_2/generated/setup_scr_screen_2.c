...
void setup_scr_screen_2(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_img_src(ui->screen_2, &_image6_240x240, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_img_opa(ui->screen_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_img_recolor_opa(ui->screen_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_2_btn_1, 157, 189);
	lv_obj_set_size(ui->screen_2_btn_1, 69, 25);
