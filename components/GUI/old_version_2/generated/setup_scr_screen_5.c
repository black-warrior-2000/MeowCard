...
void setup_scr_screen_5(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->screen_5, 240, 240);
	...
	lv_obj_set_style_bg_img_src(ui->screen_5, &_image6_240x240, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_img_opa(ui->screen_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_img_recolor_opa(ui->screen_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_5_btn_1_label, "返回");
	...
	lv_obj_set_pos(ui->screen_5_btn_1, 157, 189);
	lv_obj_set_size(ui->screen_5_btn_1, 69, 25);
	...
	lv_obj_set_style_bg_color(ui->screen_5_btn_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_5_btn_1, &lv_font_SourceHanSerifSC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
