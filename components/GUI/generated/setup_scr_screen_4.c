...
void setup_scr_screen_4(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_img_src(ui->screen_4, &_image6_240x240, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_img_opa(ui->screen_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_img_recolor_opa(ui->screen_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_4_btn_1, 157, 189);
	lv_obj_set_size(ui->screen_4_btn_1, 69, 25);
