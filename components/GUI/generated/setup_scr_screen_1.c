...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_img_src(ui->screen_1, &_image6_240x240, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_1_btn_1, 157, 189);
	lv_obj_set_size(ui->screen_1_btn_1, 69, 25);
