...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->screen_cont_1, 240, 40);
	...
	lv_obj_set_size(ui->screen_cont_2, 240, 200);
	...
	lv_label_set_text(ui->screen_label_1, "block");
	lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_1, 5, 5);
